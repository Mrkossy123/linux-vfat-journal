...
loff_t generic_file_llseek(struct file *file, loff_t offset, int whence)
{
	...
	printk(KERN_INFO "EXECUTED FUNCTION: generic_file_llseek defined in read_write.c but through file.c and struct struct file_operations fat_file_operations\n");
