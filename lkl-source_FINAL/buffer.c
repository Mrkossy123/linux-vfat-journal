...
bool block_dirty_folio(struct address_space *mapping, struct folio *folio)
{
	struct buffer_head *head;
	bool newly_dirty;
	printk(KERN_INFO "EXECUTED FUNCTION: block_dirty_folio defined in buffer.c but through inode.c and in struct address_space_operations fat_aops\n");
...
void block_invalidate_folio(struct folio *folio, size_t offset, size_t length)
{
	...
	printk(KERN_INFO "EXECUTED FUNCTION: block_invalidate_folio defined in buffer.c but through inode.c and in struct address_space_operations fat_aops\n");
	BUG_ON(!folio_test_locked(folio));
			...
			unsigned long blocksize, unsigned long b_state)
{
	...
	printk(KERN_INFO "EXECUTED FUNCTION: create_empty_buffers(...) defined in buffer.c\n");
...
void page_zero_new_buffers(struct page *page, unsigned from, unsigned to)
{
	...
	printk(KERN_INFO "EXECUTED FUNCTION: page_zero_new_buffers(...) defined in buffer.c\n");
		...
		struct page **pagep, get_block_t *get_block)
{
	...
	printk(KERN_INFO "EXECUTED FUNCTION: block_write_begin(...) defined in buffer.c\n");
